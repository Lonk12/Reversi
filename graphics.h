...
int initwindow( int width, int height, const char* );
...
void printimage( const char* title, double width_inches, double border_left_inches, double border_top_inches, int left, int right, int top, int bottom, BOOL active, HWND hwnd );
void readimagefile( const char* filename, int left, int top, int right, int bottom );
void writeimagefile( const char* filename, int left, int top, int right, int bottom, BOOL active, HWND hwnd );
